...
From Goose Require github_dot_com.mit_dash_pdos.vmvcc.cfmutex.
...
Definition Txn__abort: val :=
  rec: "Txn__abort" "txn" :=
    trusted__proph.ResolveAbort (struct.loadF Txn "proph" "txn") (struct.loadF Txn "tid" "txn");;
...
Definition Txn__commit: val :=
  rec: "Txn__commit" "txn" :=
    trusted__proph.ResolveCommit (struct.loadF Txn "proph" "txn") (struct.loadF Txn "tid" "txn") (struct.loadF Txn "wrbuf" "txn");;
...
Definition Txn__Read: val :=
  rec: "Txn__Read" "txn" "key" :=
    ...
    then ("valb", "wr")
      ...
      trusted__proph.ResolveRead (struct.loadF Txn "proph" "txn") (struct.loadF Txn "tid" "txn") "key";;
