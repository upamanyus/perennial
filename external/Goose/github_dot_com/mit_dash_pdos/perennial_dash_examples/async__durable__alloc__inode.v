(* autogenerated from github.com/mit-pdos/perennial-examples/async_durable_alloc_inode *)
From Perennial.goose_lang Require Import prelude.
From Goose Require github_dot_com.mit_dash_pdos.perennial_dash_examples.async__durable__alloc.
...
Definition Inode__mkHdr: val :=
  rec: "Inode__mkHdr" "i" :=
    let: "enc" := marshal.NewEnc async__disk.BlockSize in
...
Definition Inode__Append: val :=
  rec: "Inode__Append" "i" "b" "allocator" :=
    let: "a" := async_alloc.Alloc__AllocNum "allocator" in
    disk.Write "a" "b";;
    async_alloc.Alloc__Flush "allocator";;
    disk.Barrier #();;
    sync.Mutex__Lock (struct.loadF Inode "m" "i");;
