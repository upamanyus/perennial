...
From Goose.github_dot_com.tchajed.goose.internal.examples Require Import append__log.
...
Theorem wpc_write_hdr_fupd stk k E1 lptr (sz0 disk_sz0 sz disk_sz:u64) :
  ∀ Φ Φc,
    ...
    WPC Log__writeHdr #lptr @ stk; E1 {{ Φ }} {{ Φc }}.
Proof.
...
Theorem wpc_writeAll stk E1 bk_s bks bs0 bs (off: u64) :
  {{{ blocks_slice bk_s bks bs ∗ int.Z off d↦∗ bs0 ∗
                                 ⌜length bs0 = length bs⌝ ∗
                                 ⌜int.Z off + length bs0 < 2^64⌝ }}}
    writeAll (slice_val bk_s) #off @ stk; E1
...
Theorem wpc_Log__append k stk E1 l bs0 bk_s bks bs :
  {{{ ptsto_log l bs0 ∗ blocks_slice bk_s bks bs }}}
    Log__append #l (slice_val bk_s) @ stk; E1
